...
impl Calcable for u64 {
    ...
    fn parse_binary(s: &str) -> Result<Self, <Self as Calcable>::Err> {
        u64::from_str_radix(&clean_input(s, "0b"), 2).map_err(Into::into)
    }

    fn parse_octal(s: &str) -> Result<Self, <Self as Calcable>::Err> {
        u64::from_str_radix(&clean_input(s, "0o"), 8).map_err(Into::into)
    }

    fn parse_hex(s: &str) -> Result<Self, <Self as Calcable>::Err> {
        u64::from_str_radix(&clean_input(s, "0x"), 16).map_err(Into::into)
    }
